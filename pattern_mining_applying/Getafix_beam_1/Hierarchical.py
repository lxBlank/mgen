...
class HierarchicalCluster:
    ...
    def applyPattern(self, src_tree, src_tree_name):
        ...
        try:
            ...
            for ppp, pattern_score in enumerate(self.pattern_scores):
                self.pattern_scores[ppp][0]=pattern_score[0]
            f.close()
        pattern_scores=self.pattern_scores


        for pattern_score in pattern_scores[:14]:
        ...
        '''
        f=open('VulRepair_raw_preds_final_beam10.pkl', 'rb')
