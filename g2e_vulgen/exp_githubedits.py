...
def _eval_decode(model, test_set, beam_size=1, length_norm=False, change_vectors=None,
    ...
    batch_size = 1 if model.args['edit_encoder']['type'] == 'treediff' else 256
