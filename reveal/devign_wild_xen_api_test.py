...
if __name__ == '__main__':
    ...
    '''
    ds = './'
    parts = ['embed_devign_wild_xen_train_after_ggnn.json']
    #ds = './'
    ...
    parts = ['embed_devign_wild_xen_test_after_ggnn.json']
    features = []
    targets = []
