...
if __name__ == '__main__':
    ...
    '''
    ds = './'
    parts = ['embed_devign_non_vulgen_xen_train_after_ggnn.json']
    #ds = './'
    ...
    parts = ['embed_devign_non_vulgen_xen_test_after_ggnn.json']
    features = []
    targets = []
    ...
    for tr in range(1):
        ...
        is_test = True
        if is_test:
            f = open('devign_non_vulgen_xen.pt','rb')
            obj = pickle.load(f)
            model.model = obj[0]
            model.dataset = obj[1]
            f.close()
            ...
            f = open('devign_non_vulgen_xen.pt','wb')
