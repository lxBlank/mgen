...
if __name__ == '__main__':
    ...
    if os.path.exists(processed_data_path):
        ...
        dataset = DataSet(train_src=['devign_for_vulgen.json.shard1','devign_for_vulgen.json.shard2','devign_for_vulgen.json.shard3','devign_for_vulgen.json.shard4','devign_for_vulgen.json.shard5','vulgen_gth.json.shard1','real_world_nonvul_912.shard1'],
                          valid_src=None,
    ...
    is_test = True
    if is_test:
        model = torch.load("./models/devign_vulgen_gth_reveal/GGNNSumModel-model.bin")
        model.train()
    else:
        model.train()
